    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
        <div className="md:col-span-2">
          ...
          <p className="text-sm text-white/40 max-w-xs leading-relaxed">Professional AC services and maintenance across Karachi. Trusted by thousands of homes and businesses.</p>
      ...
      <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row justify-between items-center text-xs text-white/20">
        <p>© 2024 Full Care AC Tech. All rights reserved.</p>
